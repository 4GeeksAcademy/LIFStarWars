...
const Planets = () => {
 ...
 return (
   <div className='contenedor m-4'>
     <h2 style={{ color: "red", textAlign: "start", margin: "10px", }}> Planets</h2>
     ...
     <div className="d-flex" style={{ overflowX: "auto", whiteSpace: "nowrap" }}>
       ...
       store.planets.map((planet, index) => (
         ...
         <div className="card m-2" key={planet.uid} style={{ width: "400px", flex: " 0 0 auto", }} >
           <img src={`https://starwars-visualguide.com/assets/img/planets/${planet.uid}.jpg`} className="card-img-top bg-secondary" alt={planet.name} />
           <div className="card-body bg-secondary">
             ...
             <button type="button" className="btn btn-outline-primary" onClick={()=> navigate(`/details/planets/${planet.uid}`)}>Learn more!</button>
