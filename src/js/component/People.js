          ...
          store.characters.map((character) => (
            ...
            <div className="card m-2" key={character.uid} style={{ width: "400px", flex: " 0 0 auto", }} >
              <img
                ...
                oneError = {(e) => {
                  o.targer.onerror= null;
                  e.target.src = "https://starwars-visualguide.com/assets/img/placeholder.jpg";
                }}

                className="card-img-top bg-secondary" alt={character.name} />
              <div className="card-body bg-secondary">
                ...
                <div className='icons d-flex justify-content-between'>
                  ...
                  <button type="button" className="btn btn-outline-primary" onClick={() => navigate(`/details/people/${character.uid}`)}>Learn more!</button>
